...
describe('useModalContainer', () => {
  ...
  it('devrait retourner la référence du modal quand utilisé dans le contexte', async () => {
    const TestComponent = () => {
      const container = useModalContainer()
      React.useEffect(() => {
        // Force re-render après que le ref soit défini
      }, [container])
    ...
    // Le ref n'est pas disponible immédiatement, donc on accepte que le hook retourne null au premier render
