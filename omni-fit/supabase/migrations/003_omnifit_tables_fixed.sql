-- OmniFit Database Schema - Version corrigée
-- Version: 3.0.0
-- Date: 2025-08-15

-- S'assurer que l'extension UUID est dans public
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- Utiliser le schéma omnifit
...
SELECT table_name FROM information_schema.tables WHERE table_schema = 'omnifit' ORDER BY table_name;